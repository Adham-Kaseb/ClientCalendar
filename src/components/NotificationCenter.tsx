        ...
        <div className="p-3.5 max-h-[360px] overflow-y-auto no-scrollbar space-y-2.5 relative z-10">
          {roleNotifications.length === 0 ? (
            ...
            <>
              ...
              {/* Clear All Notifications Button After Last Item */}
              <div className="pt-2">
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={onClearAll}
                  className="w-full py-2.5 px-4 bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 rounded-[16px] text-xs font-black transition-all flex items-center justify-center gap-2 shadow-sm"
                >
